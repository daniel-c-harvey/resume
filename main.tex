...
\skillsheader{Technical Skills Summary}
    \skillsitem{Programming Languages \& ISAs}{C\#, VB.NET, C++, Java, TypeScript/JavaScript, Transact-SQL, C, HTML5, CSS3, PHP, Python, Lua, LaTeX, Matlab, Mermaid, Verilog, VHDL, ARM Assembly (Thumb-2), RISC-V}
...
\role{Application Architect}{October 2024 -- Present}{Cerebellum Softworks (Self-Employed)}{Summerville, SC}{.NET 10/9/8, C\#, Entity Framework Core, ASP.NET Core with Identity, Node.js, TypeScript, Blazor Server \& Web Assembly, MudBlazor, PostgreSQL, SQLite, Google Cloud, Azure, Digital Ocean Droplets, Rider, DataGrip, Visual Studio, VS Code, Git, NUnit, Cursor}
...
\product{Babelfish Real-Time Captioning \& Translation}{Maintenance \& Enhancement Stage}{Implemented and operated real-time captioning and translation application for live technical conference events, utilizing Google Cloud gRPC Services, ASP.NET Core, and Blazor Server to deliver seamless multilingual support and accessibility features for diverse international audiences.}
   ...
   \achievement{Operated the system during the four-day TCB Council Fall 2025 Workshop, successfully providing real-time captioning and translation in English, Japanese, Korean, and Chinese for over 28 hours of technical sessions and panel with negligible latency and high domain-language accuracy}
